      ...
      () {
        widget.listBook.sort(
          (a, b) {
            ...
            return bookB.dateCreated!
                .compareTo(bookA.dateCreated!); // Sort by latest
          },
        );
      },
    );
...
// sort books---------------------------------------------------------
          ...
          children: [
            ...
            Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    toggleSortingOrder(SortingOrder.latest);
                    setState(() {
                      sortLatest = true;
                      sortAlphabet = false;
                      sortPrice = false;
                ...
                GestureDetector(
                  onTap: () {
                    if (ascendingPrice) {
                      toggleSortingOrder(SortingOrder.lowToHigh);
                    } else {
                      toggleSortingOrder(SortingOrder.highToLow);
                    }
                    setState(() {
                ...
                GestureDetector(
                  onTap: () {
                    if (ascendingAlphabet) {
                      toggleSortingOrder(SortingOrder.alphabeticallyAToZ);
                    } else {
                      toggleSortingOrder(SortingOrder.alphabeticallyZToA);
                    }
                    setState(() {
  ...
  bool _hasFormat(HiveBookAPI? book, String format) {
    ...
    String woocommerceVariationsString = book.woocommerceVariations!;
